...
namespace EasyTags
{
    public class AddMultipleTagsToSelection : MonoBehaviour
    {
        ...
        [MenuItem("Tools/Easy Tags/Add MultipleTags to Selected", false, 10)]
        ...
        [MenuItem("Tools/Easy Tags/Add MultipleTags to Selected", true)]
        ...
        [MenuItem("Tools/Easy Tags/Add MultipleTags to All", false, 11)]
